...
window.IAGT_FEATURES = {
  ...
  renderLoop:   true,
  bulkActions:  true,
  liveData:     false,   // flip to true once Supabase creds are set
  ...
  externalApis: {
    ...
    canva:       false,  // placeholder — key not yet provisioned
    pixa:        false,  // placeholder — key not yet provisioned
    geminiOmni:  false,  // placeholder — key not yet provisioned
    predisAi:    false,  // placeholder — key not yet provisioned
    vizard:      false,  // placeholder — key not yet provisioned
