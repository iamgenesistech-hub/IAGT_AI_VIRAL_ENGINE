...
create table if not exists public.evics_renders (
  ...
  source text not null default 'evics',
  created_at timestamptz not null default now()
);

alter table public.evics_renders add column if not exists platform text;
alter table public.evics_renders add column if not exists status text not null default 'pending';
alter table public.evics_renders add column if not exists job_id text;
alter table public.evics_renders add column if not exists video_url text;
alter table public.evics_renders add column if not exists script text;
alter table public.evics_renders add column if not exists parameters jsonb not null default '{}'::jsonb;
alter table public.evics_renders add column if not exists media_type text not null default 'video';
alter table public.evics_renders add column if not exists source text not null default 'evics';
alter table public.evics_renders add column if not exists created_at timestamptz not null default now();
alter table public.evics_renders add column if not exists render_name text;
alter table public.evics_renders add column if not exists sku text;
alter table public.evics_renders add column if not exists product_name text;
alter table public.evics_renders add column if not exists render_grade integer;
alter table public.evics_renders add column if not exists product_fit integer;
alter table public.evics_renders add column if not exists brand_alignment integer;
alter table public.evics_renders add column if not exists conversion_potential integer;
alter table public.evics_renders add column if not exists viral_potential integer;
alter table public.evics_renders add column if not exists vault_destination text;
...
create policy "dashboard read evics renders"
on public.evics_renders for select
to anon, authenticated
using (true);

create policy "dashboard write evics renders"
on public.evics_renders for all
to service_role
using (true)
with check (true);
